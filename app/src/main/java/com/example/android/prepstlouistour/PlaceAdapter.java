...
public class PlaceAdapter extends ArrayAdapter <Place> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView placesTextView = (TextView) listItemView.findViewById ( R.id.learn );
        //Gets the text for the place and sets it on the TextView.
        placesTextView.setText ( currentPlaces.getPlacesVisit () );
        ...
        detailsTextView.setText ( currentPlaces.getPlacesDetails () );


        //Finds the TextView for the addresses of the place to visit.

        TextView addressesTextView = (TextView) listItemView.findViewById ( R.id.address );
        //Gets the text for the addresses and sets it on the TextView.
        addressesTextView.setText ( currentPlaces.getPlacesAddresses () );
